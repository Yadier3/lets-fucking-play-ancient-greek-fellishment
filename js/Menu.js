...
let Menu = new Phaser.Class({
  ...
  create: function () {
    ...
    this.cameras.main.setBackgroundColor('rgba(163, 13, 0)');
    let titleStyle = {
    ...
    let title = this.add.text(this.game.canvas.width / 2, 10, "LET'S FUCKING PLAY:\nANCIENT GREEK FELLISHMENT", titleStyle);
